...
function generatebloonsprite(spriteIndex)
{
	...
	var overlayRotate = 0;
	if (bloonData.type == "bob" || bloonData.type == "bobmega")
	{
	}
	else if (bloonData.type == "honey1" || bloonData.type == "honey2" || bloonData.type == "honey3" || bloonData.type == "honey4" || bloonData.type == "honey5")
	{
	}
	else if (has(mods, atr.moab))
	{
